...
class AssetModel extends Asset {
  const AssetModel({
    ...
    super.warrantySpaceId,
    super.warrantySpaceName,
    ...
    super.insuranceSpaceId,
    super.insuranceSpaceName,
  ...
  factory AssetModel.fromJson(Map<String, dynamic> json) {
    return AssetModel(
      ...
      warrantySpaceId: json['warrantySpaceId'] as int?,
      warrantySpaceName: json['warrantySpaceName'] as String?,
      ...
      insuranceSpaceId: json['insuranceSpaceId'] as int?,
      insuranceSpaceName: json['insuranceSpaceName'] as String?,
